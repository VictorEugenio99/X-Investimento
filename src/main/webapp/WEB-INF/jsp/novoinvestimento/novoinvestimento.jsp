    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 text-center">Novo investimento</h1>
          <div class="row"></div>
          ...
          <div class="card shadow mb-4 card-novaaposta mx-auto">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary text-center">Selecione um ou mais Investimentos</h6>
            </div>
            <div class="card-body">
            ...
            <div class="card-footer text-center">
              <a href="" class="btn btn-primary btn-icon-split btn-lg mt-3 mb-3">
                <span class="icon text-white-50">
                  <i class="fas fa-check"></i>
                </span>
                <span class="text">Salvar Investimento</span>
              </a>
            </div>
          </div>
          <!-- / Fim do Card-->
